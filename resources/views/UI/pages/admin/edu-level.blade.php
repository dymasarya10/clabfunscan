...
@section('main-admin-section')
    <div class="row">
                                ...
                                <td>
                                    <div class="container-fluid">
                                        <div class="row row-cols-1 row-cols-lg-2 justify-content-center">
                                            <div class="col p-1">
                                                <button class="btn btn-sm btn-warning w-100" onclick="OpenEditFormData('{{ $edu_level['nama_jenjang'] }}')">
                                                    Edit
                                                </button>
                                            </div>
                                            <div class="col p-1">
                                                <form
                                                    action="{{ route('destroyedulevels', ['id' => base64_encode($edu_level->id)]) }}"
                                                    method="POST">
                                                    @method('DELETE')
                                                    @csrf
        ...
        <div class="col-12 col-xl-5" id="form_edit_data_jenjang">
            <div class="bg-white rounded-4 p-4 AppShadow">
                ...
                <form>
                    <div class="mb-3">
                        ...
                        <input name="nama_jenjang" type="text" class="form-control" id="inputEdit" aria-describedby="emailHelp">
                        <div id="emailHelp" class="form-text">cth: SMP</div>
                    </div>
                    <div class="btn btn-danger" onclick="CloseEditFormData()">Batal</div>
