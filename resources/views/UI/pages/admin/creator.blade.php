...
@section('main-admin-section')
    ...
    <div class="row row-cols-1">
        <div class="col">
            ...
            <div class="bg-white rounded-4 p-4 AppShadow mb-4 animate__animated animate__faster d-none" id="create_creator">
                <h5 class="mb-4">Tambah Data Creator</h5>
                @if ($edulvls->count() < 1)
                    <div class="container-fluid fst-italic text-secondary d-flex flex-column">
                        <div class="container">
                            <i class="fa-solid fa-circle-exclamation"></i>&nbsp;&nbsp;Belum ada jenjang yang tersedia !
                        ...
                        <div class="col-12">
                            <form action="{{ route('creators.store') }}" method="POST" enctype="multipart/form-data"
                                    ...
                                    <div class="d-flex">
                                        <div class="me-3">
                                            <img src="{{ asset('myassets/img/emptyfile.png') }}" alt=""
                                                class="rounded-circle" width="90rem" height="90rem" id="previewImg">
                                        </div>
                                        <div class="">
                                ...
                                <div class="mb-3">
                                    <div class="row row-cols-1 row-cols-md-2">
                                        <div class="col">
                                            ...
                                            is-invalid
                                        @enderror"
                                                aria-describedby="emailHelp" value="{{ old('nama_pengguna_post') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    is-invalid
                                @enderror"
                                        aria-describedby="emailHelp" name="email_post" value="{{ old('email_post') }}">
                                    @error('email_post')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    is-invalid
                                @enderror"
                                        id="exampleInputPassword1" name="password_post" value="{{ old('password_post') }}">
                                    @error('password_post')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
            ...
            <div class="bg-white rounded-4 p-4 AppShadow mb-4 animate__animated animate__faster d-none" id="update_creator">
                    ...
                    <div class="mb-3">
                        <div class="d-flex">
                            ...
                            <div class="">
                                ...
                                @enderror
                                <div class="form-text fst-italic">Kosongkan jika tidak ingin mengganti foto. Maks 3mb</div>
                            </div>
                        </div>
                    </div>
                    <div class="mb-3">
